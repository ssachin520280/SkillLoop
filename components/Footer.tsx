      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-600 mb-4">A decentralized skill-sharing platform built on Hathor Network.</p>
        ...
        <div className="border-t border-gray-200 mt-12 pt-8 text-center text-gray-600 text-sm">
          <p>© {new Date().getFullYear()} SkillLoop. All rights reserved. Built on Hathor Network.</p>
        </div>
      </div>
    </footer>
  )
